...
public:
    ...
    void get_details()
    {
        ...
        cin>>mobileNo;
        cout<<"Enter Customer Adress: "<<endl;
        cin>>address;
...
public:
    ...
    {
        cout<<"----------A B C Cabs----------\n"<<endl;
        cout<<"1. Rent a Standard Cab -15 TK for 1 km"<<endl;
        cout<<"2. Rwnt a luxury Cab- 25 TK for 1 km"<<endl;

        cout<<"\n To calculate the cost for your journey: "<<endl;
        cout<<"\n Enter which kind of cab you need: "<<endl;
        cin>>cabChoice;
        cout<<"\n Enter kilometers you travel: "<<endl;
        cin>>kilometers;
        int hirecab;
        if(cabChoice==1)
        {
            cabCost=kilometers*15;
            cout<<"\n Your tour cost is "<<cabCost<<" TK "<<endl;
        ...
        else if(cabChoice==2)
        {
            ...
            cout<<"\n Press 1 redirect Main menu: "<<endl;;
            cin>>hirecab;
            system("CLS");
            if(hirecab==1){
                menu();
